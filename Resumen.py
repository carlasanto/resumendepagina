...
#ESCRAPEA ARTICULO DE WIKIPEDIA
enlace = "https://en.wikipedia.org/wiki/Artificial_intelligence"
...
# REMOVIENDO DE CORCHETES Y ESPACIOS EXTRAS Y CARACTERES MOLESTOS
...
stopwords = nltk.corpus.stopwords.words('english')   #IDIOMA DE LA PAGINA A RESUMIR
...
for sent in sentence_list:  
    for word in nltk.word_tokenize(sent.lower()):
        if word in word_frequencies.keys():
            if len(sent.split(' ')) < 40:                   #TAMAÑO DEL RESUMEN
